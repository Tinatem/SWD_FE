    ...
    return (
        <div className="w-full bg-[#eaf4fa] px-28 py-3 rounded-md space-y-2">
            ...
            <div className="relative">
                <Input placeholder="Nhập mã đơn hàng/tên sản phẩm" className="px-16" value={search} onChange={(event) => {
                    setSearch(event.target.value);
                }} />
                <img src={research} alt="research" className="w-6 h-6 absolute left-4 top-2" />
            </div>
        </div>
    )
}
